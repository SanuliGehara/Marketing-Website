...
const teamMembers = [
  {
    ...
    image: 'https://i.imgur.com/laslq9q.jpeg',
  ...
  },
  {
    ...
    bio: 'Software Engineering Undergraduate with strong pssion for web devepolment. Interested in on machine learning and animal health applications.',
  },
  {
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex justify-center space-x-4">
                  ...
                  <a href={member.github} className="text-gray-500 hover:text-petorange">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
