    ...
    <section id="pricing" className="section bg-blue-50">
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-md overflow-hidden transition-transform hover:scale-105 duration-300">
            ...
            <div className="p-8">
              ...
              <Button className="w-full bg-gray-200 hover:bg-gray-400 text-petblue-dark">
                Get Started
              </Button>
            </div>
          </div>
          ...
          {/* Premium Tier */}
          <div className="bg-gradient-to-br from-petorange-light/30 to-petorange/30 rounded-2xl shadow-lg overflow-hidden border-2 border-petorange relative transition-transform hover:scale-105 duration-300">
            <div className="absolute top-0 right-0 bg-petorange text-white px-4 py-1 rounded-bl-lg text-sm font-medium">
              Most Popular
            </div>
            <div className="p-8 border-b border-petorange/20">
            ...
            <div className="p-8">
              <ul className="space-y-4 mb-8">
                {premiumTierFeatures.map((feature, index) => (
                  <li key={index} className="flex items-center">
                    <Check className="h-5 w-5 text-petorange mr-3 flex-shrink-0" />
                    <span className="text-gray-600">{feature}</span>
                  </li>
                ))}
              </ul>
              <Button className="w-full bg-petorange hover:bg-petorange-dark text-white">
                Get Premium
              </Button>
            </div>
          </div>
        ...
        <div className="text-center mt-12 bg-white py-8 px-6 rounded-xl shadow-sm max-w-3xl mx-auto">
          ...
          <Button variant="outline" className="border-petorange text-petorange hover:bg-petorange/10">
